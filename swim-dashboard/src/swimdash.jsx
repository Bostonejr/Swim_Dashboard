        ...
        <div className="grid md:grid-cols-2 gap-4">
          ...
          <div className="bg-red-950/40 border border-red-800/40 rounded-xl p-5">
            ...
            <ul className="space-y-2 text-red-100 text-sm leading-relaxed list-disc list-inside">
              ...
              <li>
                Raphael's T5 was corrected from 4.21s to 32.51s — logging
                protocol should be improved to prevent future recording errors
              </li>
            </ul>
          </div>
        </div>
  ...
  <div className="space-y-5">
    <div className="bg-slate-800 rounded-2xl p-6">
      ...
      {[
        ...
        [
          "Raphael T5",
          "Originally recorded as 4.21s (recording error). Corrected to 32.51s per updated source document. All metrics now use the full clean 10-rep set.",
        ],
      ].map(([k, v]) => (
        <div
          key={k}
